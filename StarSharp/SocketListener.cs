...
namespace StarSharp
{
	public class SocketListener
	{
		...
		public SocketListener(SocketListenerSettings listenerSettings)
		{
			this.socketListenerSettings = listenerSettings;
		...
		private void ProcessAccept(SocketAsyncEventArgs acceptEventArgs)
		{
			...
			Int32 max = StarSharp.Instance.maxSimultaneousClientsThatWereConnected;
			Int32 numberOfConnectedSockets = Interlocked.Increment(ref this.numberOfAcceptedSockets);
			if (numberOfConnectedSockets > max)
			{
				Interlocked.Increment(ref StarSharp.Instance.maxSimultaneousClientsThatWereConnected);
			}
